...
7. Rank branches only through the stored solution canonical energy after fixed-point or unmixed-orbit gates and fingerprint checks pass. Use the orbit phase average for periodic solutions. Never rank saved effective-Hamiltonian eigenvalues directly.
