...
\date{Literature through 7 September 2026; project update 18 September 2026}
...
\subsection*{Project evidence update: 18 September 2026}

The synchronized project data now include the full unfrustrated-cubic grid,
six finer square coordinates, three completed repulsive-$V$ square starts
and the first completed trellis start. These are local results, not findings
...
At square $(1.2,+0.2)$ the stripe, paired and intertwined period-16 starts
all lose anomalous pairing. The period-eight test has only a partial scalar
log. Repulsive $V$ therefore cannot yet be presented as a general mechanism
for intertwining based on the legacy frustrated-cubic result. Conversely,
the first one-ladder trellis stripe start develops opposite-sign leg/rung
pairing at $(1,0)$. This reinforces the need to match geometry and the
competing channels when connecting isolated-ladder tendencies to array order.
...
established. All 34 completed histories in this update remain unaccepted
