...
[Bollmark, Koehler, and Kantian, Phys. Rev. B 111, 125141 (2025)](https://doi.org/10.1103/PhysRevB.111.125141) demonstrates multichannel CDW/SC MPS+MF competition in coupled chains. Independent phase seeds and a common stationary functional are therefore central, rather than optional bookkeeping.
...
1. Accepted period-1 fixed points from independent SC, SDW, and CDW seeds, plus forward/reverse continuations near transitions.
...
The most promising near-term result remains a controlled geometry-dependent competition among magnetic and pairing fixed points. The publishable advance is not a larger mean-field amplitude by itself; it is a variationally ranked, recurrence-resolved, provenance-complete phase diagram with controlled isolated-ladder and finite-entanglement diagnostics.
